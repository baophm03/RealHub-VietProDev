  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-1/2 -right-3 z-50 flex h-12 w-6 translate-y-[-50%] items-center justify-center rounded-sm border border-border bg-surface shadow-sm transition-colors hover:bg-surface-muted"
      >
        {collapsed ? (
