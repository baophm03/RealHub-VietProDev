  ...
  if (!article) {
    return (
      <div className="flex flex-col items-center gap-3 py-16 text-center">
        ...
        <Button variant="outline" onClick={() => router.push("/news-contents")}>
          Quay lại
        </Button>
      </div>
    );
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <PageHeader eyebrow="Tin tức" title="Chỉnh sửa bài viết" description={article.title} />
      </div>
        ...
        <FormSection title="Phân loại & Hình ảnh" description="Chuyên mục và ảnh đại diện">
          <FormField label="Chuyên mục">
            <Select
              ...
              onValueChange={(val) =>
                setValue("categoryNewsId", val === "__none__" ? undefined : val ?? undefined)
              }
            >
              <SelectTrigger>
