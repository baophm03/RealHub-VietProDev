...
import { usePostApiNews } from "@/lib/api/endpoints/news";
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <PageHeader eyebrow="Tin tức" title="Thêm bài viết" description="Tạo bài viết tin tức mới" />
      </div>
        ...
        <FormSection title="Phân loại & Hình ảnh" description="Chuyên mục và ảnh đại diện">
          <FormField label="Chuyên mục">
            <Select
              ...
              onValueChange={(val) => setValue("categoryNewsId", val === "__none__" || val == null ? undefined : val)}
            >
              <SelectTrigger>
