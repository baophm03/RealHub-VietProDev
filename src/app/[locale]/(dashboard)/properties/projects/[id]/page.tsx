    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={() => router.push(`/properties/projects/${id}/edit`)}
        >
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2 text-sm text-foreground-muted">
          ...
          <CaretRight size={12} />
          <Link href="/properties?tab=projects" className="transition-colors hover:text-foreground">
            Dự án
          </Link>
          <CaretRight size={12} />
      ...
      <section className="flex flex-col gap-4">
        <div className="flex items-center justify-between border-b border-border pb-3">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push(`/properties/properties/new?projectId=${id}`)}
          >
            Thêm BĐS vào dự án
          </Button>
        </div>
