          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            {deal.customerId && (
              <div>
                ...
                <button
                  onClick={() => router.push(`/dashboard/customers/${deal.customerId}`)}
            ...
            {deal.propertyId && (
              <div>
                ...
                <button
                  onClick={() => router.push(`/dashboard/properties/${deal.propertyId}`)}
                  className="block text-sm text-primary hover:underline"
                >
                  {deal.propertyId}
                </button>
            ...
            {deal.leadId && (
              <div>
                ...
                <button
                  onClick={() => router.push(`/dashboard/leads/${deal.leadId}`)}
                  className="block text-sm text-primary hover:underline"
                >
                  {deal.leadId}
                </button>
